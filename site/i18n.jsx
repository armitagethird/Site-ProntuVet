...
const I18N = {
  pt: {
    ...
    hero_sub: 'ProntuVet escuta sua conversa com o tutor e devolve um prontuário clínico estruturado — anamnese, exame físico, diagnóstico e prescrição — em segundos.',
    ...
    price_title: 'Comece grátis. Assine quando fizer sentido.',
    price_sub: 'Sem fidelidade, sem pegadinha. Cancele quando quiser.',

    price_free_name: 'Gratuito',
    price_free_desc: 'Para experimentar e usar no dia a dia leve.',
    ...
    price_free_feats: [
      ...
      'Prontuário Padrão + 1 template próprio',
      'Resumo para tutor',
      'Anexos até 25MB',
    ],

    price_plat_name: 'Platinum',
    price_plat_desc: 'Para quem atende em volume e vive do produto.',
    price_plat_price: 'R$ 79',
  ...
  en: {
    ...
    hero_sub: 'ProntuVet listens to your conversation with the pet owner and returns a structured clinical record — history, physical exam, diagnosis and prescription — in seconds.',
    ...
    price_title: 'Start free. Subscribe when it makes sense.',
    price_sub: 'No lock-in, no tricks. Cancel whenever you want.',

    price_free_name: 'Free',
    price_free_desc: 'To try and use casually.',
    price_free_price: '$0',
    ...
    price_free_feats: [
      '20 visits per month',
      '15 visits per day',
      'Default record + 1 custom template',
      'Owner summary',
      'Attachments up to 25MB',
    ],

    price_plat_name: 'Platinum',
    price_plat_desc: 'For vets with volume, living in the product.',
    price_plat_price: '$15',
